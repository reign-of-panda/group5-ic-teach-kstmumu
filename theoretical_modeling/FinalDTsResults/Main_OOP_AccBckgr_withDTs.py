...
class LHCb:
    ...
    def decision_trees(self, combinatorial = True, peaking = True, careful = False):
        if combinatorial:
            self.combinatorial_tree()
        if peaking:
            self.peaking_trees(careful)
    ...
    def peaking_trees(self, careful):
        model = None
       ...
       'B0_OWNPV_Y', 'B0_OWNPV_Z', 'B0_FD_OWNPV', 'accept_kaon', 'accept_pion', 'accept_muon', 'B0_MM'])
        ...
        if careful: # how much data to filter out
    ...
    def run_analysis(self):
        ...
        self.chi_sq_filter()
        print("Starting peaking filtering...")
        self.peaking()
        # self.from_sensitivity_analysis()

        print("Starting decision trees...")
        # Decision Trees applied to data
        self.decision_trees(combinatorial = False, peaking = False, careful = True) # first param to apply combinatorial DT, second to apply peaking bg decision trees
